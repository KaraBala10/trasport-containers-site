...
interface WhatsAppButtonProps {
  phoneNumber: string; // رقم الواتساب بصيغة دولية (مثال: 31612345678)
...
export default function WhatsAppButton({ 
  ...
  useEffect(() => {
    // إظهار الزر بعد التحميل لتجنب مشاكل hydration
    setIsVisible(true);
  }, []);

  const handleClick = () => {
    const defaultMessage = language === 'ar' 
      ? 'مرحباً، أود الاستفسار عن خدمات الشحن'
      : 'Hello, I would like to inquire about shipping services';
