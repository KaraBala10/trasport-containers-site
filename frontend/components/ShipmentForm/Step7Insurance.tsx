...
export default function Step7Insurance({
  ...
  const translations = {
    ar: {
      ...
      optionalInsuranceDesc: 'يمكنك اختيار تأمين إضافي على قيمة الشحنة (1.5% من القيمة المعلنة)',
      ...
      mandatoryInsuranceDesc: 'التأمين إلزامي للإلكترونيات بنسبة 1% من القيمة المعلنة',
    ...
    en: {
      ...
      optionalInsuranceDesc: 'You can choose additional insurance on shipment value (1.5% of declared value)',
      ...
      mandatoryInsuranceDesc: 'Insurance is mandatory for electronics at 1% of declared value',
  ...
  const mandatoryInsuranceCost = hasElectronics ? electronicsDeclaredValue * 0.01 : 0; // 1% for electronics
    ...
    <div className="space-y-8">
      ...
      >
        <div className="mb-4">
          ...
          <p className="text-sm text-gray-600 mb-2">{t.optionalInsuranceDesc}</p>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => onOptionalInsuranceChange(parseFloat(e.target.value) || 0)}
      ...
      {hasElectronics && (
        ...
        >
          <div className="mb-4">
            ...
            <p className="text-sm text-purple-700 mb-2">{t.mandatoryInsuranceDesc}</p>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-purple-100 rounded-xl p-4 border-2 border-purple-300">
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-purple-900 font-semibold">{t.insuranceCost}</span>
      ...
      {totalInsuranceCost > 0 && (
        ...
        >
          <div className="flex justify-between items-center">
            <span className="text-2xl font-bold text-primary-dark">{t.totalInsurance}</span>
      ...
      {!hasElectronics && optionalInsuranceValue === 0 && (
        <div className="text-center py-8 text-gray-500">
          {language === 'ar' 
            ? 'التأمين اختياري. يمكنك إضافة قيمة التأمين أعلاه إذا رغبت.' 
            : 'Insurance is optional. You can add insurance value above if desired.'}
        </div>
      )}
    </div>
  );
