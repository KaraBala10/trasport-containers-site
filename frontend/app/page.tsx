  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main id="main-content" className="flex-grow" role="main">
        ...
        <section
          className="bg-gradient-to-r from-primary-dark to-primary-dark relative overflow-hidden"
        ...
        >
          <div className="container mx-auto px-4">
            <h2
              id="services-heading"
              className="text-4xl font-bold text-center mb-8 text-primary-dark"
            >
              {t.serviceTitle}
            </h2>
            ...
            >
              <div
                className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-xl transition-shadow focus-within:ring-4 focus-within:ring-primary-yellow/30"
                role="listitem"
              >
                <div
                  className="w-16 h-16 bg-primary-yellow rounded-full flex items-center justify-center mx-auto mb-4"
                  aria-hidden="true"
                >
        ...
        <section className="py-16 bg-gray-50" aria-labelledby="video-heading">
          <div className="container mx-auto px-4">
            <h2
              id="video-heading"
              className="text-4xl font-bold text-center mb-4 text-primary-dark"
            >
              {t.videoTitle}
            </h2>
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-primary-dark to-primary-dark">
                  <div className="text-center text-white">
                    ...
                    <p className="text-lg font-semibold">
                      {language === "ar"
                        ? "فيديو تعريفي - سيتم إضافة الفيديو الحقيقي"
                        : "Intro Video - Real video will be added"}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 bg-white" aria-labelledby="gallery-heading">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6" role="list">
              ...
              <figure
                className="relative h-64 rounded-lg overflow-hidden shadow-lg bg-gradient-to-br from-gray-200 to-gray-300 focus-within:ring-4 focus-within:ring-primary-yellow/50"
                role="listitem"
              >
                <Image
        ...
        <section className="py-16 bg-gray-50" aria-labelledby="trust-heading">
          <div className="container mx-auto px-4">
            ...
            >
              <div
                className="bg-white p-6 rounded-lg text-center min-w-[150px] shadow-md hover:shadow-lg transition-shadow focus-within:ring-4 focus-within:ring-primary-yellow/30"
                role="listitem"
              >
                <p
