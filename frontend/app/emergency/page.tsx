      ...
      <main className="flex-grow" role="main">
        ...
        <div className="bg-red-600 text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-4">{content.mainTitle}</h1>
            <p className="text-2xl md:text-3xl font-semibold mb-2 text-red-100">{content.subtitle}</p>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 md:p-12 border-4 border-primary-yellow shadow-2xl">
                ...
                <div className="mb-8">
                  <div className="inline-flex items-center gap-3 bg-primary-yellow/20 px-6 py-3 rounded-full">
                    ...
                    <span className="text-xl font-bold">{content.availability}</span>
                  </div>
                </div>
                ...
                >
                  <div className="text-6xl md:text-7xl lg:text-8xl font-bold mb-4 text-white group-hover:text-primary-yellow transition-colors duration-300" dir="ltr">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                  <svg className="w-12 h-12 mx-auto mb-4 text-primary-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <h3 className="font-bold text-lg mb-2">{language === 'ar' ? 'البريد الإلكتروني' : 'Email'}</h3>
                  <a href={`mailto:${content.alternativeContact.email}`} className="text-primary-dark hover:text-primary-yellow transition-colors">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 text-center">
                  ...
                  <h3 className="font-bold text-lg mb-2">{language === 'ar' ? 'واتساب' : 'WhatsApp'}</h3>
                  <p className="text-gray-700">{content.alternativeContact.whatsapp}</p>
                </div>
              </div>
              
              <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg">
                <p className="text-gray-700 text-center">{content.alternativeContact.note}</p>
              </div>
              
              {/* Languages */}
              <div className="mt-8 text-center">
                <h3 className="text-xl font-bold text-primary-dark mb-3">{content.languages.title}</h3>
                <p className="text-lg text-gray-700">{content.languages.list}</p>
              </div>
            </div>
          </div>
        </div>
