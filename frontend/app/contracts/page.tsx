...
export default function ContractsPage() {
  ...
  const translations = {
    ar: {
      title: 'العقود',
      description: 'نماذج العقود والاتفاقيات',
      comingSoon: 'قريباً',
      placeholder: 'هذه الصفحة قيد التطوير. سيتم إضافة نماذج العقود قريباً.',
    },
    en: {
      title: 'Contracts',
      description: 'Contract templates and agreements',
      comingSoon: 'Coming Soon',
      placeholder: 'This page is under development. Contract templates will be added soon.',
    },
  };
