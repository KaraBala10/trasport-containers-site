            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 border-t-4 border-primary-yellow">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-primary-dark">{content.servicesInfo.lcl.title}</h3>
                </div>
                <p className="text-gray-700">{content.servicesInfo.lcl.description}</p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 border-t-4 border-primary-dark">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-primary-dark">{content.servicesInfo.fcl.title}</h3>
                </div>
                <p className="text-gray-700">{content.servicesInfo.fcl.description}</p>
              </div>
            </div>
          </div>
        </div>
