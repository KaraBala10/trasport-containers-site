...
export default function PricingPage() {
  ...
  const translations = {
    ar: {
      title: 'الأسعار والحاسبة',
      description: 'احسب تكلفة شحنتك بشكل فوري',
      comingSoon: 'قريباً',
      placeholder: 'هذه الصفحة قيد التطوير. سيتم إضافة حاسبة الأسعار قريباً.',
    },
    en: {
      title: 'Pricing & Calculator',
      description: 'Calculate your shipping cost instantly',
      comingSoon: 'Coming Soon',
      placeholder: 'This page is under development. The pricing calculator will be added soon.',
    },
  };
