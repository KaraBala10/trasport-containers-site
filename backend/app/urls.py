...
urlpatterns = [
    ...
    path(
        ...
        update_lcl_shipment_status_view,
        name="lcl_shipment_status",
    ),
    path(
        "shipments/<int:shipment_id>/approve-eu-shipping/",
        approve_eu_shipping_view,
        name="approve_eu_shipping",
    ),
    path(
        "shipments/<int:shipment_id>/delete-eu-shipping/",
        delete_eu_shipping_view,
        name="delete_eu_shipping",
    ),
    path(
